<div class="form-group" id="assignto_selector"{!!  (isset($style)) ? ' style="'.e($style).'"' : ''  !!}>
    ...
    <div class="col-md-8">
        <div class="btn-group" data-toggle="buttons">
            ...
            @if ((isset($client_select)) && ($client_select!='false'))
            <label class="btn btn-default">
                <input name="checkout_to_type" value="client" aria-label="checkout_to_type" type="radio"><i class="fa fa-barcode" aria-hidden="true"></i> {{ trans('general.client') }}
            </label>
            @endif
