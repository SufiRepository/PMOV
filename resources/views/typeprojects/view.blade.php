...
{{-- Page title --}}
@section('title')
{{ trans('admin/typeprojects/table.view') }} -
{{ $supplier->name }}
@parent
@stop

@section('header_right')
  <a href="{{ route('typeprojects.edit', $supplier->id) }}" class="btn btn-default pull-right">
  {{ trans('admin/typeprojects/table.update') }}</a>
@stop
...
<div class="row">
  <div class="col-md-9">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        <!-- checked out typeprojects table -->
