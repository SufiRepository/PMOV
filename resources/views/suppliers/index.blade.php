...
<a href="{{ route('suppliers.create') }}" class="btn btn-primary pull-right" style="margin-right: 5px;">  {{ trans('general.new_supplier') }}</a>
@endcan
@stop
@section('content')
        ...
        <div class="table-responsive">
          <div class="box-header with-border">
            <div class="box-heading">
              <h2 class="box-title"> {{ trans('general.listofsupplier') }}</h2>
            </div>
          </div><!-- /.box-header -->
          <table
