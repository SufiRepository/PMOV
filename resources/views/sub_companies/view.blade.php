                    ...
                    <div class="tab-pane fade in active" id="asset_tab">
                        ...
                        <div class="table-responsive">
                            <table
                                    ...
                                    data-url="{{route('api.assets.index',['sub_company_id' => $sub_company->id]) }}"
                                    data-export-options='{
                              "fileName": "export-companies-{{ str_slug($sub_company->name) }}-assets-{{ date('Y-m-d') }}",
                    ...
                    <div class="tab-pane" id="licenses_tab">
                        <div class="table-responsive">
                            ...
                            <table
                                    ...
                                    id="licensesTable"
                                    class="table table-striped snipe-table"
                                    data-url="{{route('api.licenses.index',['sub_company_id' => $sub_company->id]) }}"
                                    data-export-options='{
                              "fileName": "export-companies-{{ str_slug($sub_company->name) }}-licenses-{{ date('Y-m-d') }}",
                              "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                              }'>
                            </table>
                    ...
                    <div class="tab-pane" id="accessories_tab">
                        <div class="table-responsive">
                            ...
                            <table
                                    ...
                                    id="accessoriesTable"
                                    class="table table-striped snipe-table"
                                    data-url="{{route('api.accessories.index',['sub_company_id' => $sub_company->id]) }}"
                                    data-export-options='{
                              "fileName": "export-companies-{{ str_slug($sub_company->name) }}-accessories-{{ date('Y-m-d') }}",
                              "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                              }'>
                            </table>
                    ...
                    <div class="tab-pane" id="consumables_tab">
                        <div class="table-responsive">
                            ...
                            <table
                                    ...
                                    id="consumablesTable"
                                    class="table table-striped snipe-table"
                                    data-url="{{route('api.consumables.index',['sub_company_id' => $sub_company->id]) }}"
                                    data-export-options='{
                              "fileName": "export-companies-{{ str_slug($sub_company->name) }}-consumables-{{ date('Y-m-d') }}",
                              "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                              }'>
                            </table>
                    ...
                    <div class="tab-pane" id="components_tab">
                        <div class="table-responsive">
                            ...
                            <table
                                    ...
                                    id="componentsTable"
                                    class="table table-striped snipe-table"
                                    data-url="{{route('api.components.index',['sub_company_id' => $sub_company->id]) }}"
                                    data-export-options='{
                              "fileName": "export-companies-{{ str_slug($sub_company->name) }}-components-{{ date('Y-m-d') }}",
                              "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                              }'>
                    ...
                    <div class="tab-pane" id="users_tab">
                        <div class="table-responsive">
                            ...
                            <table
                                    ...
                                    id="usersTable"
                                    class="table table-striped snipe-table"
                                    data-url="{{route('api.users.index',['sub_company_id' => $sub_company->id]) }}"
                                    data-export-options='{
                              "fileName": "export-companies-{{ str_slug($sub_company->name) }}-users-{{ date('Y-m-d') }}",
                              "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                              }'>
