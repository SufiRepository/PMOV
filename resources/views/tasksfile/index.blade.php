    ...
    <div class="box box-default">
      <div class="box-body">
        <table
                ...
                data-url="{{ route('api.taskuploads.index') }}"
                data-export-options='{
...
@include ('partials.bootstrap-table', ['exportFile' => 'Tasks-export', 'search' => true,'showFooter' => true, 'columns' => \App\Presenters\TaskFilePresenter::dataTableLayout()])
@stop