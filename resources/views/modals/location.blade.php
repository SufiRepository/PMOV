    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('api.locations.store') }}" onsubmit="return false">
                ...
                {{-- new add by farez 4/6/2021 --}}
                <div class="dynamic-form-row">
                    <div class="col-md-4 col-xs-12"><label for="modal-name">{{ trans('general.gps') }}:
                        </label></div>
                    <div class="col-md-8 col-xs-12 ">
                        <div class="col-xs-5">
                        <input class="form-control" type="text" name="longitude" placeholder="longitude"aria-label="longitude" id='modal-name' />
                        </div>
                        <div class="col-xs-5">
                        <input class="form-control" type="text" name="latitude" placeholder="latitude"aria-label="latitude" id='modal-name' />
                        </div>
                    </div>
                </div>
