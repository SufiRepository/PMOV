    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="#" style="color: rgb(255, 255, 255)" class="sidebar-toggle btn btn-white" data-toggle="push-menu" role="button">
            ...
            <div class="navbar-custom-menu">
              <ul class="nav navbar-nav">
                  ...
                  <li aria-hidden="true"{!! (Request::is('projects*') ? ' class="active"' : '') !!}>
                      <a href="{{ route('projects.index') }}" tabindex="-1">
           ...
           {{--   @can('index', \App\Models\Project::class)
            <li class="treeview{!! (Request::is('project*') ? ' active ' : '') !!} ">
                <a href="#"><i class="fa fa-tasks" aria-hidden="true"></i>
                 <span>{{ trans('admin/hardware/general.Project') }}</span>
...
{{-- <li{!! (Request::query('status') == 'Deployed' ? ' class="active"' : '') !!}>
            ...
            @can('backend.interact')
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @can('view', \App\Models\StatusTask::class)
                        <li {!! (Request::is('statustasks*') ? ' class="active"' : '') !!}>
                            <a href="{{ route('statustasks.index') }}">
                                {{ trans('general.statustask') }}
                            </a>
                        </li>
                        @endcan
                       {{-- end add  --}}
                        ...
                        <li>
                            <a href="{{ route('clients.index') }}" {{ (Request::is('/clients') ? ' class="active"' : '') }}>
                                {{ trans('general.clients') }}
                            </a>
                        </li>
                       @endcan

                        {{-- new add by farez 15/6/2021 --}}
                        @can('view', \App\Models\Contractor::class)
                        <li>
                            <a href="{{ route('contractors.index') }}" {{ (Request::is('/contractors') ? ' class="active"' : '') }}>
                                {{ trans('general.contractors') }}
                            </a>
                        </li>
                        @endcan
                         {{-- end --}}
            ...
            <li{!! (Request::is('helpdesk*') ? ' class="active"' : '') !!}>
            <a href="{{ route('helpdesks.index') }}">
            <i class="fa fa-question-circle" aria-hidden="true"></i>
            <span>{{ trans('admin/hardware/general.Helpdesk') }}</span>
            </a>
            </li>
            @endcan
            ...
            <i class="fa fa-question-circle" aria-hidden="true"></i>
            <span>{{ trans('admin/roles/general.roles') }}</span>
            </a>
            </li>
            @endcan

            @can('index', \App\Models\BillQuantity::class)
            <li{!! (Request::is('billquantity*') ? ' class="active"' : '') !!}>
            <a href="{{ route('billquantities.index') }}">
            <i class="fa fa-question-circle" aria-hidden="true"></i>
            <span>{{ trans('admin/hardware/general.billquantity') }}</span>
            </a>
            </li>
            @endcan --}}
      ...
      <footer class="main-footer hidden-print">
        ...
        @endif
          ...
          <a target="_blank" href="https://snipeitapp.com" rel="noopener">Managemet System </a> , made with <i class="fa fa-heart" style="color: #bb2b26; font-size: 10px" aria-hidden="true"></i><span class="sr-only">love</span> by <a href="https://twitter.com/snipeitapp" rel="noopener">Mindwave</a>.
      </footer>
