@extends('layouts/edit-form', [
    'createText' => trans('Create Subtask') ,
    'updateText' => trans('Update Subtask'),
    'helpPosition'  => 'right',
...
@include ('partials.forms.edit.name', ['translated_name' => trans('Subtask')])
{{-- {{$item->priority}} --}}
...
<div class="form-group {{ $errors->has('contract_start_date') ? ' has-error' : '' }}">
 ...
 <div class="form-group {{ $errors->has('contract_duration') ? ' has-error' : '' }}">
    <label for="contract_duration" class="col-md-3 control-label">{{ 'Project Duration' }}</label>
    <div class="col-md-9">
