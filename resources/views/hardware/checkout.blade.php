            ...
            <div class="box box-default">
                <form class="form-horizontal" method="post" action="" autocomplete="off">
                  ...
                  The asset <a href="{{ route('hardware.edit', $asset->id) }}">should be edited</a> to correct this before attempting to check it in or out.</span>
                    ...
                    @include ('partials.forms.edit.client-select', ['translated_name' => trans('general.client'), 'fieldname' => 'assigned_client', 'unselect' => 'true', 'style' => 'display:none;', 'required'=>'true'])
