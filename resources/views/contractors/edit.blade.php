@extends('layouts/edit-form', [
    ...
    'updateText' => trans('admin/contractors/table.update'),
...
<div class="form-group {{ $errors->has('contact') ? ' has-error' : '' }}">
    {{ Form::label('contact', trans('admin/contractors/table.contact'), array('class' => 'col-md-3 control-label')) }}
    <div class="col-md-7">
...
<div class="form-group {{ $errors->has('fax') ? ' has-error' : '' }}">
    {{ Form::label('fax', trans('admin/contractors/table.fax'), array('class' => 'col-md-3 control-label')) }}
    <div class="col-md-7">
...
<div class="form-group {{ $errors->has('url') ? ' has-error' : '' }}">
    {{ Form::label('url', trans('admin/contractors/table.url'), array('class' => 'col-md-3 control-label')) }}
    <div class="col-md-7">
...
@if (($item->image) && ($item->image!=''))
    <div class="form-group {{ $errors->has('image_delete') ? 'has-error' : '' }}">
        ...
        <div class="col-md-5">
            ...
            <br>
            <img src="{{ url('/') }}/uploads/contractors/{{ $item->image }}" alt="Image for {{ $item->name }}" class="img-responsive">
