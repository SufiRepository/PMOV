...
return array(
    ...
    'Expiring_Project_Report' => 'Expiring Project Report.',

    'Expiring_ImplementationPlan_Report' => 'Expiring Implementation Plan Report.',

    'Expiring_Task_Report' => 'Expiring Task Report.',

    'Expiring_Subtask_Report' => 'Expiring Licenses Report.',
    ...
    'login_first_admin' => 'Login to your new PMO installation using the credentials below:',
    'login' => 'Login:',
    ...
    'supplier' => 'Supplier',
    'tag' => 'Tag',
    'test_email' => 'Test Email from PMO',
    'test_mail_text' => 'This is a test from the PMO Asset Management System. If you got this, mail is working :)',
    ...
    'project_expiring_alert' => 'There is :Project expiring in the next :threshold days.|There are :Projects expiring in the next :threshold days.',
    'implementationplan_expiring_alert' => 'There is : ImplementationPlan expiring in the next :threshold days.|There are :ImplementationPlans expiring in the next :threshold days.',
    'task_expiring_alert' => 'There is :Task expiring in the next :threshold days.|There are :Tasks expiring in the next :threshold days.',
    'subtask_expiring_alert' => 'There is :Subtask expiring in the next :threshold days.|There are :Subtasks expiring in the next :threshold days.',
    ...
    'your_credentials' => 'Your PMO credentials',
