...
class Location extends SnipeModel
{
    ...
    */
     ...
     * @var array
     */
    protected $searchableAttributes = ['name', 'address', 'city', 'state', 'zip', 'created_at', 'ldap_ou', 'longitude', 'latitude'];
    ...
    //end add
     ...
     // new add by farez 13/6/2021
    public function tasks()
    {
        return $this->hasMany('\App\Models\Task', 'location_id');
    }
    //end add
