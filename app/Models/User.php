...
// end client count
    ...
    public function isSuperUser()
    {
     ...
     /**
     * Checks if the user is a admin company
     * 
    ...
    // add by farez
     ...
     /**
     * Establishes the user -> project relationship
     *
    ...
    {
        return $this->hasMany('\App\Models\Team', 'team_id');
    }
...
// end add
    ...
    /**
     * Establishes the user -> client relationship
     *
     * @author farez@mindawave.com
     * @since [v3.0]
     * @return \Illuminate\Database\Eloquent\Relations\Relation
     */
