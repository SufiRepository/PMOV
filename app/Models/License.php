...
class License extends Depreciable
{
    ...
    */
    protected $fillable = [
        'company_id',
        'project_id',  //add by farez 7/6/21
        'depreciation_id',
        'expiration_date',
        'license_email',
    ...
    //Add by farez 17//2021

     /**
     * Establishes the license -> project relationship
     *
    ...
    // untuk kira totol license per project
    ...
    // add by farez 8/6/2021

    /**
     * Establishes the license -> client relationship
     *
     * @author farez@mindwave.my
     * @since [v1.0]
     * @return \Illuminate\Database\Eloquent\Relations\Relation
    ...
    {
        return $query->leftJoin('projects as projects', 'licenses.project_id', '=', 'projects.id')->select('licenses.*')
