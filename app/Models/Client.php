...
class Client extends SnipeModel
{
    use SoftDeletes;
...
// end client count
    ...
    {
        return $this->hasMany(Asset::class)->whereNull('deleted_at')->selectRaw('client_id, count(*) as count')->groupBy('client_id');
    }
    ...
    /**
     * Establishes the client -> assets relationship
     *
    ...
    {
        return $this->hasMany('\App\Models\Asset', 'client_id');
    }

    /**
     * Establishes the client -> accessories relationship
     *
    ...
    {
        return $this->hasMany('\App\Models\Accessory', 'client_id');
    }

    /**
     * Establishes the client -> asset maintenances relationship
     *
     * @author A. Gianotto <snipe@snipe.net>
     * @since [v1.0]
     * @return \Illuminate\Database\Eloquent\Relations\Relation
    ...
    {
        return $this->hasMany('\App\Models\AssetMaintenance', 'client_id');
    }

    /**
     * Return the number of assets by client
     *
     * @author farez@mindwave.my
     * @since [v1.0]
     * @return int
    ...
    /**
     * Establishes the client -> license relationship
     *
    ...
    {
        return $this->hasMany('\App\Models\License', 'client_id');
    }

    /**
     * Return the number of licenses by client
     *
     * @author farez@mindwave.my
     * @since [v1.0]
     * @return int
    ...
    /**
     * Add http to the url in clients if the user didn't give one
     *
