...
class AssetsTransformer
{
    ...
    {
        $array = [
            'id' => (int) $asset->id, 'name' => e($asset->name),'asset_tag' => e($asset->asset_tag),'serial' => e($asset->serial),'model' => ($asset->model) ? ['id' => (int) $asset->model->id,'name'=> e($asset->model->name)  ] : null,

            'project'        => ($asset->project)        ? ['id' => $asset->project->id,'name'=> e($asset->project->name)] : null,
        ...
        $permissions_array['available_actions'] = [
            ...
            // 'view'      => Gate::allows('view'      , Asset::class),
            'view'      => Gate::allows('view'      , Asset::class),
