...
class ComponentsTransformer
{
    ...
    public function transformComponent(Component $component)
    {
        $array = [
            ...
            'company'   => ($component->company) ? [     'id' => (int) $component->company->id,     'name' => e($component->company->name) ] : null,

            'project'   => ($component->project) ? [     'id' => (int) $component->project->id,     'name' => e($component->project->name) ] : null,
