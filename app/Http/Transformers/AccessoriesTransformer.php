...
class AccessoriesTransformer
{
    ...
    public function transformAccessory (Accessory $accessory)
    {
        $array = [
            ...
            'project'        => ($accessory->project)        ? ['id' => $accessory->project->id,'name'=> e($accessory->project->name)] : null,
            ...
            'serial'   => ($accessory->serial)   ? e($accessory->serial) : null,
        ...
        $permissions_array['available_actions'] = [
            ...
            'view'    => Gate::allows('view'  , Accessory::class),
