...
class AssetsController extends Controller
{
    ...
    public function store(ImageUploadRequest $request)
    {
        ...
        if ($success) {
            ...
            return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success',trans('admin/hardware/message.create.success'));
    ...
    public function update(ImageUploadRequest $request, $assetId = null)
    {
        ...
        $asset->project_id = $request->input('project_id',null);
