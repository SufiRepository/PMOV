...
class AccessoriesController extends Controller
{
    ...
    public function store(ImageUploadRequest $request)
    {
        ...
        $accessory->project_id              = request('project_id');
        $accessory->order_number            = request('order_number');
        $accessory->manufacturer_id         = request('manufacturer_id');
        $accessory->model_number            = request('model_number');
        $accessory->serial                   = request('serial');
        ...
        if ($accessory->save()) {
            ...
            $projectId = $accessory->project_id;
            $project = Project::find($projectId);

            return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success',trans('admin/accessories/message.create.success'));
    ...
    public function destroy($accessoryId)
    {
        ...
        return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success',trans('admin/accessories/message.delete.success'));
