    ...
    public function index(Request $request)
    {
        ...
        $allowed_columns = [
            ...
            $departments = Department::select([
                ...
                'departments.image'
            ])->with('users')->with('department')->with('manager')->with('company')->withCount('users as users_count');
            
            $departments = Company::scopeCompanyables($departments);
        ...
        $offset = (($departments) && (request('offset') > $departments->count())) ? $departments->count() : request('offset', 0);
