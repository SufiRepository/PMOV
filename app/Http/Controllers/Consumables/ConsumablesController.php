...
class ConsumablesController extends Controller
{
    ...
    public function store(ImageUploadRequest $request)
    {
        ...
        if ($consumable->save()) {
            ...
            $projectId = $consumable->project_id;
            $project = Project::find($projectId);
    
            return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success',trans('admin/consumables/message.create.success'));
    ...
    public function update(ImageUploadRequest $request, $consumableId = null)
    {
        ...
        if ($consumable->save()) {
            ...
            return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success',trans('admin/consumables/message.update.success'));
    ...
    public function destroy($consumableId)
    {
        ...
        return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success',trans('admin/consumables/message.delete.success'));
