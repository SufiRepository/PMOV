...
class LicensesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $license->project_id        = $request->input('project_id');
        ...
        if ($license->save()) {
            ...
            return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success', trans('admin/licenses/message.create.success'));
    ...
    public function destroy($licenseId)
    {
        ...
        if ($license->assigned_seats_count == 0) {
            ...
            return redirect()->route('projectsreroute', ['projectid' => $projectId])->with('success', trans('admin/licenses/message.delete.success'));
