...
abstract class SnipePermissionsPolicy
{
    ...
    /**
    * AHMAD SUFI Modify specific
    *
    * @param  \App\Models\User  $user
    * @return mixed
    */
    public function viewColumn(User $user)
    {
        return $user->hasAccess($this->columnName().'.thisColumn');
    }
    public function viewColumnDisabled(User $user)
    {
        return $user->hasAccess($this->columnName().'.thisColumnDisabled');
    }
