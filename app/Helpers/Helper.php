...
class Helper
{
    ...
    {
        $statusttask = array('' => trans('general.select_statustask')) + StatusTask::orderBy('default_label', 'desc')->orderBy('name','asc')
    ...
    public static function checkLowInventory()
    {
        ...
        // $tasks    =  Task::whereNotNull('contract_end_date')
        ...
        //                     ->get();
         ...
         $tasks = task::whereNotNull('contract_end_date')->get();
        ...
        //     $diffInDays = $task->contract_end_date->diff(Carbon::now())->days;
            
        //     if ($avail < ($task->contract_end_date) + \App\Models\Setting::getSettings()->alert_threshold) {
              
        //         $items_array[$all_count]['id'] = $task->id;
        //         $items_array[$all_count]['name'] = $task->name;
        //         $items_array[$all_count]['type'] = 'tasks';
